...
| `0x400d64da .. 0x400d7c3c` | 5,986 B | 2 | octamax (all features), octabam (`0x400d6b00`), standalone 1.40MIDISC (`0x400d6500..0x400d7c48`, its `tools/midisc/memory_map.py` @`eaf46d7`), **octalab `0x400d64e0..0x400d72c4`** (build OLB20, measured by diff against stock) — contested, nearly full |
